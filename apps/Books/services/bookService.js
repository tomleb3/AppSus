...
export const bookService = { query, getBookById, saveBooksToStorage, remove, clearBookStorage }

const STORAGE_KEY = 'booksDB'
var books
_createBooks()

function query() { return Promise.resolve(books) }
...
function _createBooks() {
    books = storageService.load(STORAGE_KEY);
